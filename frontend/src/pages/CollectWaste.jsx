  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 px-6 py-12'>
      ...
      <div className='max-w-4xl mx-auto text-center mb-12'>
        ...
        <p className='text-gray-600 text-lg sm:text-xl'>Browse reported waste in your community. Collect open reports and make a difference!</p>
      </div>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto'>
        {filteredReports.map((report) => (
          ...
          >
            <img className='w-full h-48 object-cover' src={report.image} alt={report.type} />
            <div className='p-6'>
              ...
              <p className="text-gray-700 mb-4">
                <span className="font-semibold">Reported by:</span> {report.user}
              </p>
              <button
